...
You can attach a name and branch name to your command and specify where you're pushing to.
...
- [Remote Branched Documentation](https://git-scm.com/book/en/v2/Git-Branching-Remote-Branches#_tracking_branches)
